...
qc5rep_hdmse_peakpicking_featurelist_MZMINE <- read_xlsx("data/qc5rep_hdmse_peakpicking_featurelist_MZMINE.xlsx") |> 
  mutate(across(!"id" & !ends_with("_state") & !ends_with("_unit"), as.double))
...
# Also needs to add filter by rt and dt
...
# HRMS data 
## find hits from a suspect list data frame in the featurelist
