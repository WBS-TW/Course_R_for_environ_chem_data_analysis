...
-   Go to Settings \> SSH and GPG keys. Click "New SSH key". 
-   Paste your public key in the "Key" box. Give it an informative title, presumably repeating the descriptive comment (such as RStudio_LiU) you used above, during key creation. 
-   Click "Add SSH key".

### 4. [Connect your project to GitHub](https://happygitwithr.com/push-pull-github)
  
You can either create a new project in Github and then 
**a.** 
-   