...
# Publish your data analysis in Quarto

-   Handbook on Quarto for R can be found here: <https://r4ds.hadley.nz/quarto.html>

-   You can either publish your book/webpage in Posit Cloud or Github Pages. Below are instructions on how to publish in these two platforms.
...
Edit your \_quarto.yml to output the generated html book into a \docs folder. Otherwise Github pages cannot publish the book on your project website (it will instead generate the html files in the \_books folder).
