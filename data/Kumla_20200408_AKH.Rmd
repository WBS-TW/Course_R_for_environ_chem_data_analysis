...
```{r loading data, warning=FALSE,include=FALSE, message=FALSE}
...
#setwd("C:/Users/akh/Desktop/R Kumla")
...
kumla_conc <- as_tibble(read_excel("D:/Projects/PFAS-riparian/experimental/Results/2020/Kumla/20200409-R_analysis/Statistics_Kumla_20200408.xlsx", 
                                 sheet = "Overview")) %>%
...
#color
matrix_color <- setNames(c12, c(levels(kumla_conc$Group)))
